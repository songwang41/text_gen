...
from ..bart_rnn.modeling_bart_rnn import (
...
MODEL_FOR_PRETRAINING_MAPPING = OrderedDict(
    [
        ...
        (BartRNNConfig, BartRNNForConditionalGeneration),
...
MODEL_FOR_SEQUENCE_CLASSIFICATION_MAPPING = OrderedDict(
    [
        ...
        (BartRNNConfig, BartRNNForSequenceClassification),
...
MODEL_FOR_QUESTION_ANSWERING_MAPPING = OrderedDict(
    [
        ...
        (BartRNNConfig, BartRNNForQuestionAnswering),
