...
# 2. once modified, run: `make deps_table_update` to update src/transformers_BAG/dependency_versions_table.py
_deps = [
    "black>=20.8b1",
    "cookiecutter==1.7.2",
    "dataclasses",
...
class DepsTableUpdateCommand(Command):
    ...
    user_options = [
        ...
        ("dep-table-update", None, "updates src/transformers_BAG/dependency_versions_table.py"),
    ]
    ...
    def run(self):
        ...
        target = "src/transformers_BAG/dependency_versions_table.py"
...
# when modifying the following list, make sure to update src/transformers_BAG/dependency_versions_check.py
install_requires = [
